...
app.layout = html.Div(style=background_gradient, children=[
    ...
    dbc.Row([
        dbc.Col(
            ...
            width=6,
            className='mx-auto',
            style={'margin-bottom': '10px', 'margin-top': '10px'},  # Ajuste da margem superior e inferior
        ),
    ...
    dbc.Row([
        dbc.Col(
            ...
            width=11,
            className='mx-auto',
            style={'margin-bottom': '30px', 'margin-top': '10px'},  # Ajuste da margem superior e inferior
        ),
    ]),
])
